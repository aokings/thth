...
def mime_for(row,cap=None):
    if row['kind']=='audio':
        choices={'mp4':('audio/mp4','audio/m4a','audio/x-m4a'),'mov':('video/quicktime',),'wav':('audio/wav','audio/wave','audio/x-wav','audio/vnd.wave'),'flac':('audio/flac','audio/x-flac'),'mp3':('audio/mpeg','audio/mp3'),'ogg':('audio/ogg','audio/opus'),'ogg_vorbis':('audio/ogg',),'webm':('audio/webm',)}.get(row['format'],())
