...
def render_worker_service(credentials: str) -> str:
    ...
    return (
        '# Generated by thth systemd --worker --credentials PATH\n'
        '# Save as thth-worker.service; credentials remain in their private file.\n'
        '# Replacing thth-approval-worker.service (3.12.0 and earlier): docs/運用_招待する側.md §6.\n'
        '[Unit]\n'
        'Description=THTH worker (invitations, /activity, safety controls)\n'
        'After=network-online.target\n'
        'Wants=network-online.target\n\n'
        '[Service]\n'
        'Type=simple\n'
        ...
        'UMask=0077\n'
        f'ExecStart=/srv/thth/app/bin/thth worker --credentials {credentials}\n'
        'Restart=on-failure\n'
        'RestartSec=5\n\n'
        '[Install]\n'
