...
before(async()=>{
  ...
  const files=['test/invite-harness.js','src/worker.js','src/invite.js','src/invite-object.js','src/media.js','src/media-object.js','src/index.js','src/relay.js','src/relay-object.js','src/approval.js','src/approval-object.js','src/deletion.js','src/deletion-object.js'];
